...
local themes = {
	...
	PetalPink = {
		['Shadow'] = Color3.fromRGB(244, 166, 185), -- Petal Pink glow
		['Background'] = Color3.fromRGB(34, 32, 34), -- Soft Charcoal Gray
		['Page'] = Color3.fromRGB(26, 24, 26),       -- Deeper Petal Gray
		['Main'] = Color3.fromRGB(244, 166, 185),     -- Petal Pink Main Accent
		['Text & Icon'] = Color3.fromRGB(245, 240, 242), -- Crisp Pink-tinted White
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(42, 39, 42),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(54, 48, 52),
					['Toggle Value'] = Color3.fromRGB(244, 166, 185), -- Active Pink
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(38, 35, 38),
					['Toggle Value'] = Color3.fromRGB(65, 60, 65),     -- Muted Petal Gray
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(42, 39, 42),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(42, 39, 42),
				['Value Background'] = Color3.fromRGB(26, 24, 26),
				['Value Stroke'] = Color3.fromRGB(244, 166, 185), -- Pink Outline
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(26, 24, 26),
					['Search'] = Color3.fromRGB(46, 42, 46),
					['Item Background'] = Color3.fromRGB(54, 49, 54),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(42, 39, 42),
				['Value Background'] = Color3.fromRGB(26, 24, 26),
				['Value Stroke'] = Color3.fromRGB(244, 166, 185),
				['Slider Bar'] = Color3.fromRGB(55, 50, 55),
				['Slider Bar Value'] = Color3.fromRGB(244, 166, 185), -- Pink Slider Fill
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(42, 39, 42)), ColorSequenceKeypoint.new(1, Color3.fromRGB(42, 39, 42))},
				['Background Code'] = Color3.fromRGB(52, 47, 52),
				['Background Code Value'] = Color3.fromRGB(36, 33, 36),
				['ScrollingFrame Code'] = Color3.fromRGB(244, 166, 185)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(42, 39, 42),
				['Click'] = Color3.fromRGB(244, 166, 185)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(42, 39, 42),
				['Value Background'] = Color3.fromRGB(26, 24, 26),
			...
			['Keybind'] = {
				...
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(54, 48, 52),
					['Toggle Value'] = Color3.fromRGB(244, 166, 185),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(38, 35, 38),
					['Toggle Value'] = Color3.fromRGB(65, 60, 65),
				}
			},
			['Color Picker'] = {
				['Background'] = Color3.fromRGB(42, 39, 42),
				['Color Select'] = {
					['Background'] = Color3.fromRGB(26, 24, 26),
					['UIStroke'] = Color3.fromRGB(244, 166, 185),
				}
			}
		}
	},
